...
public class Docker_Build extends LoadData {

	public Docker_Build() throws FileNotFoundException, IOException, ParseException {
		super();
	}
	...
	public void validate_Sensitive_fields_masking_in_UI_and_Logs()
		...
		String[] plugins = { "gitscm1", "Docker_Maven", "docker_build_&_push" };
