...
public class SonarQube extends LoadData {

	public SonarQube() throws FileNotFoundException, IOException, ParseException {
		super();
	}
	...
	public void validate_Sensitive_fields_masking_in_UI_and_Logs_SonarQube(String pluginname, String Stage)
	...
	public void pipeline_Creation_With_One_Stage_SonarQube(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
	...
	public void trigger_Pipeline_with_One_Stage_SonarQube(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
	...
	public void plugin_UI_fields_Validation_SonarQube(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		pv.navigateToPipeLineEditor();
	...
	public void addition_Of_Plugin_in_Pipeline_SonarQube(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		pv.navigateToPipeLineEditor();
	...
	public void UIValidation_for_Mandatory_Fields_SonarQube(String pluginname, String Stage)
	...
	@Test(enabled = true, priority = 7, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage_SonarQube" })
	public void edit_pipeline_SonarQube(String pluginname, String Stage) throws InterruptedException {
	...
	@Test(enabled = true, priority = 8, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage_SonarQube" })
	public void clone_pipeline_SonarQube(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		pv.openPipelineView();
