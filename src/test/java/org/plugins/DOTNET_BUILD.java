...
public class DOTNET_BUILD extends LoadData {

	public DOTNET_BUILD() throws FileNotFoundException, IOException, ParseException {
		super();
	}
	...
	public void validate_Sensitive_fields_masking_in_UI_and_Logs_DOTNET_BUILD(String pluginname, String Stage)
	...
	public void pipeline_Creation_With_One_Stage_DOTNET_BUILD(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
	...
	public void trigger_Pipeline_with_One_Stage_DOTNET_BUILD(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
	...
	public void plugin_UI_fields_Validation_DOTNET_BUILD(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		pv.navigateToPipeLineEditor();
	...
	public void addition_Of_Plugin_in_Pipeline_DOTNET_BUILD(String pluginname, String Stage)
	...
	public void UIValidation_for_Mandatory_Fields_DOTNET_BUILD(String pluginname, String Stage)
			throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
	...
	@Test(enabled = true, priority = 7, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage_DOTNET_BUILD" })
	public void edit_pipeline_DOTNET_BUILD(String pluginname, String Stage) throws InterruptedException {
	...
	@Test(enabled = true, priority = 8, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage_DOTNET_BUILD" })
	public void clone_pipeline_DOTNET_BUILD(String pluginname, String Stage) throws InterruptedException {
