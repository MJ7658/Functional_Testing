...
public class MAVEN_PACKAGE extends LoadData {

	public MAVEN_PACKAGE() throws FileNotFoundException, IOException, ParseException {
		super();
	}
	...
	public void validate_Sensitive_fields_masking_in_UI_and_Logs_MAVEN_PACKAGE(String pluginname, String Stage)
	...
	public void pipeline_Creation_With_One_Stage_MAVEN_PACKAGE(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
	...
	public void trigger_Pipeline_with_One_Stage_MAVEN_PACKAGE(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
	...
	public void plugin_UI_fields_Validation_MAVEN_PACKAGE(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		pv.navigateToPipeLineEditor();
	...
	public void addition_Of_Plugin_in_Pipeline_MAVEN_PACKAGE(String pluginname, String Stage)
	...
	public void UIValidation_for_Mandatory_Fields_MAVEN_PACKAGE(String pluginname, String Stage)
			throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
	...
	@Test(enabled = true, priority = 7, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage_MAVEN_PACKAGE" })
	public void edit_pipeline_MAVEN_PACKAGE(String pluginname, String Stage) throws InterruptedException {
	...
	@Test(enabled = true, priority = 8, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage_MAVEN_PACKAGE" })
	public void clone_pipeline_MAVEN_PACKAGE(String pluginname, String Stage) throws InterruptedException {
