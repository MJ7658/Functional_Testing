...
public class GITSCM extends LoadData {

	public GITSCM() throws FileNotFoundException, IOException, ParseException {
		super();
	}
	...
	public Object[][] getDataFromDataprovider() {
		return new Object[][] { { "GITSCM", null } };

	}

	@Test(enabled = true, priority = 1, dataProvider = "Plugin_TestData")
	public void validate_Sensitive_fields_masking_in_UI_and_Logs_GITSCM(String pluginname, String Stage)
	...
	public void pipeline_Creation_With_One_Stage_GITSCM(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
	...
	public void trigger_Pipeline_with_One_Stage_GITSCM(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
	...
	public void plugin_UI_fields_Validation_GITSCM(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		Thread.sleep(2000);
		logger.info("plugin_UI_fields_Validation_GITSCM");
		Thread.sleep(60000);
	}

	@Test(enabled = true, priority = 5, dataProvider = "Plugin_TestData")
	public void addition_Of_Plugin_in_Pipeline_GITSCM(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		pv.navigateToPipeLineEditor();
	...
	public void UIValidation_for_Mandatory_Fields_GITSCM(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		Thread.sleep(2000);
		logger.info("UIValidation_for_Mandatory_Fields_GITSCM");
		Thread.sleep(60000);
	}

	@Test(enabled = true, priority = 7, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage_GITSCM" })
	public void edit_pipeline_GITSCM(String pluginname, String Stage) throws InterruptedException {
	...
	@Test(enabled = true, priority = 8, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage_GITSCM" })
	public void clone_pipeline_GITSCM(String pluginname, String Stage) throws InterruptedException {
