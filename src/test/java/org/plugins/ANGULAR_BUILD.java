...
public class ANGULAR_BUILD extends LoadData {
	...
	public void validate_Sensitive_fields_masking_in_UI_and_Logs_ANGULAR_BUILD(String pluginname, String Stage)
	...
	public void pipeline_Creation_With_One_Stage_ANGULAR_BUILD(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
	...
	public void trigger_Pipeline_with_One_Stage_ANGULAR_BUILD(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
	...
	public void plugin_UI_fields_Validation_ANGULAR_BUILD(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		pv.navigateToPipeLineEditor();
	...
	public void addition_Of_Plugin_in_Pipeline_ANGULAR_BUILD(String pluginname, String Stage)
	...
	public void UIValidation_for_Mandatory_Fields_ANGULAR_BUILD(String pluginname, String Stage)
			throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		Thread.sleep(3000);
		logger.info("UIValidation_for_Mandatory_Fields_ANGULAR_BUILD");
		Thread.sleep(60000);
		logger.info("Execution completed");
	}

	@Test(enabled = true, priority = 7, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage_ANGULAR_BUILD" })
	public void edit_pipeline_ANGULAR_BUILD(String pluginname, String Stage) throws InterruptedException {

		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		logger.info("edit_pipeline_ANGULAR_BUILD Execution started");
		pv.openPipelineView();
		Thread.sleep(60000);
	...
	@Test(enabled = true, priority = 8, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage_ANGULAR_BUILD" })
	public void clone_pipeline_ANGULAR_BUILD(String pluginname, String Stage) throws InterruptedException {

		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		logger.info("clone_pipeline_ANGULAR_BUILD Execution started");
		PipelineView pv = new PipelineView(driver);
		pv.openPipelineView();
		Thread.sleep(60000);
	}
