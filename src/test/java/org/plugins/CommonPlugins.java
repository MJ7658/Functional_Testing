...
public class CommonPlugins extends LoadData {

	public CommonPlugins() throws FileNotFoundException, IOException, ParseException {
		super();
	}
	...
	public Object[][] getDataFromDataprovider() {
		return new Object[][] { { "ITAF", null }, { "GITSCM", null }, { "IFAST", null }, { "ANDROID_LINT", null }, // dev
				{ "SonarQube", null }, { "DOTNET_BUILD", null }, { "TSLINT_CODE_ANALYSIS", null },
				{ "GITSCM", "JMETER" }, { "GITSCM_MAVEN", "MAVEN_PACKAGE" }, { "GITSCM", "ANGULAR_BUILD" },
				{ "GITSCM", "PYTHON_BUILD" },
	...
	public void validate_Sensitive_fields_masking_in_UI_and_Logs(String pluginname, String Stage)
	...
	public void pipeline_Creation_With_One_Stage(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
	...
	public void trigger_Pipeline_with_One_Stage(String pluginname, String Stage)
			throws InterruptedException, FileNotFoundException, IOException, ParseException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
	...
	public void plugin_UI_fields_Validation(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		pv.navigateToPipeLineEditor();
	...
	public void addition_Of_Plugin_in_Pipeline(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		pv.navigateToPipeLineEditor();
	...
	public void UIValidation_for_Mandatory_Fields(String pluginname, String Stage) throws InterruptedException {
		driver = ListenersTest.driver;
		logger = ListenersTest.logger;
		PipelineView pv = new PipelineView(driver);
		pv.navigateToPipeLineEditor();
		...
		if (Stage == null) {
			...
			pv.expandPluginDetails(Stage);
		}
		Thread.sleep(60000);
	}

	@Test(enabled = false, priority = 7, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage" })
	public void edit_pipeline(String pluginname, String Stage) throws InterruptedException {
	...
	@Test(enabled = false, priority = 8, dataProvider = "Plugin_TestData", dependsOnMethods = {
			"trigger_Pipeline_with_One_Stage" })
	public void clone_pipeline(String pluginname, String Stage) throws InterruptedException {
