...
public class TC_PythonBuild_plugin extends LoadData {
	...
	@Test(priority = 1)
	public void validate_PythonBuild_Plugin() throws Exception {
		...
		ph.addGitSCMInput("gitscm", "https://github.com/satheshkumar-m_infosys/pythonpluginTest.git",
				"Z2hwX3BnVnhHSjlwc2NOSGxOMkdVWnNJSE1RTmpFUXFISjJCVXFGVw==");
		ph.dyanamicStepAndPlugin("stage1", "Python Build");

		ph.addPython_BuildpluginInput("Python-Build", "pythonpluginTest/JenkinsPipeline-master/",
				"pythonpluginTest/JenkinsPipeline-master/");
		...
		String result = ph.getLog("running install_scripts");
		boolean flag;
		if (result.contains("running install_scripts")) {
			flag = true;
		} else {
			flag = false;
		}
