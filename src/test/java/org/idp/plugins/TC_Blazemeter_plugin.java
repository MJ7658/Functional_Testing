...
public class TC_Blazemeter_plugin extends LoadData {
	...
	@Test(priority = 1)
	public void validate_Blazemeter_Plugin() throws Exception {
		...
		ph.dyanamicStepAndPlugin("stage1", "Blazemeter");
		ph.addBlazemeterpluginInput("Blazemeter", "https://idp.com", "43o0934", "sjkladfjkfs", "test",
				"balazemeterids");
