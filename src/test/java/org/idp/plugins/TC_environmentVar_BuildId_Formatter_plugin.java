...
public class TC_environmentVar_BuildId_Formatter_plugin extends LoadData {
	...
	@Test(priority = 1)
	public void validate_environmentVar_BuildId_Plugin() throws Exception {
		...
		ph.dyanamicStepAndPlugin("stage1", "environmentVar_BuildId_Formatter");
		ph.addenvironmentVar_BuildId_FormatterpluginInput("environmentVar_BuildId_Formatter", "Step");
		...
		System.out.println(fileter[1].trim());
		boolean flag;
