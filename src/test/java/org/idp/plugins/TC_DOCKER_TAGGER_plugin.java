...
public class TC_DOCKER_TAGGER_plugin extends LoadData {
	...
	@Test(priority = 1)
	public void validate_DOCKER_TAGGER_Plugin() throws Exception {
		...
		ph.dyanamicStepAndPlugin("stage1", "Docker Tagger");
		ph.addDockerTaggerpluginInput("Docker-Tagger", "https://idp.com", "github.com", "sathesh", "sjkladfjkfs",
